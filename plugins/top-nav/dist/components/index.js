...
var TopNav = ({ fileData, displayClass }) => {
  const slug2 = fileData.slug;
  if (!slug2) return null;
  return /* @__PURE__ */ u2("nav", { class: displayClass ? `top-nav ${displayClass}` : "top-nav", children: NAV_LINKS.map(([label, target]) => /* @__PURE__ */ u2("a", { href: resolveRelative(slug2, target), class: "internal", children: label })) });
};
TopNav.css = `
.top-nav {
  display: flex;
...
export { TopNav_default as TopNav };
